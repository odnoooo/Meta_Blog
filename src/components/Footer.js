...
export const Footer = () => {
  return (
    <div className="lg:w-screen bg-gray-100">
      <div className=" text-gray-500 flex flex-col gap-6 bg-gray-100 py-16 lg:gap-20 lg:w-[1096px]">
        ...
        <div className="border-t-[1px] border-slate-300 flex flex-col py-6 gap-12 lg:flex-row lg:justify-between">
